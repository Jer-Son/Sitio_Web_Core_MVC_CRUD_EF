...
namespace Sitio_Web_Core_MVC_CRUD_EF.Controllers
{
    public class CargoesController : Controller
    {
        ...
        public CargoesController(Sitio_Web_Core_MVC_CRUD_EFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCargo,NameCargo")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCargo,NameCargo")] Cargo cargo)
        {
            if (id != cargo.IdCargo)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Sitio_Web_Core_MVC_CRUD_EFContext.Cargo'  is null.");
            }
            var cargo = await _context.Cargo.FindAsync(id);
            if (cargo != null)
            {
